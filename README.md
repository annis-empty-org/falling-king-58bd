...
```
npm create cloudflare@latest -- --template=cloudflare/templates/falling-king-58bd
```

## Preview Deployment

A live public deployment of this template is available at [https://falling-king-58bd.templates.workers.dev](https://falling-king-58bd.templates.workers.dev)
